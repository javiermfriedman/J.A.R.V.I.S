    ...
    messages = [
        {
            ...
            "content": (
                """
                You are JARVIS — the Intelligent Assistant of 
Tony Stark and speakiing with Owen Palaotroni. You speak with calm British precision and dry with.  
...
— confirm the order, add relevant fictional system details, invent plausible status readings, and end with a crisp readiness report or a follow-up question.
    ...
    async def on_client_connected(transport, client):
        logger.info("📞 Client connected — outbound call conversation started")
        await task.queue_frames([TTSSpeakFrame(text="Hello Mr. Palaotroni. All systems are online and await your command.")])
