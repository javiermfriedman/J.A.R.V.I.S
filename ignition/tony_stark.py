...
if __name__ == "__main__":
    ...
    # play_saved_audio("/Users/javierfriedman/Code/J.A.R.V.I.S/ignition/welcome_home.mp3")
    # time.sleep(1)
    # play_saved_audio("/Users/javierfriedman/Code/J.A.R.V.I.S/ignition/sfx_ai.mp3", background=True)
    # play_saved_audio("/Users/javierfriedman/Code/J.A.R.V.I.S/ignition/open_dev.mp3", background=True)
    # time.sleep(2)
    start_dev_server()  
